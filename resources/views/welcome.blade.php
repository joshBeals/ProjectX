      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{ asset('assets/images/logo/logo-1.png') }}" alt=""><img class="img-fluid for-dark" src="{{ asset('assets/images/logo/logo.png') }}" alt=""></a></div>
            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown">
                ...
                <div class="onhover-show-div notification-dropdown">
                  ...
                  <div class="d-flex align-items-center"><img src="{{ asset('assets/images/dashboard/user/5.png') }}" alt="">
                  ...
                  <div class="d-flex align-items-center"><img src="{{ asset('assets/images/dashboard/user/6.png') }}" alt="">
                    <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                        <h5>
                  ...
                  <div class="d-flex align-items-center figma-line"><img src="{{ asset('assets/images/dashboard/user/7.png') }}" alt="">
                    <div class="flex-grow-1 ms-2"><a href="user-profile.html">
                  ...
                  <ul>
                    <li>
                      <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1">
                          <h5 class="mb-1"><a href="../template/email_inbox.html">Helen Walter</a></h5>
                    ...
                    <li>
                      <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1">
                          <h5 class="mb-1"><a href="../template/email_inbox.html">Jason Borne</a></h5>
                    ...
                    <li>
                      <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1">
                          <h5 class="mb-1"><a href="../template/email_inbox.html">Sarah Loren</a></h5>
                          <p>What`s the project report update?</p>
                        </div>
                        <div class="notification-right"><i data-feather="x"></i></div>
                      </div>
                    </li>
                    <li><a class="f-w-700" href="../template/private-chat.html">Check all</a></li>
                  </ul>
                </div>
              </li>
              <li class="cart-nav onhover-dropdown">
                ...
                <div class="cart-dropdown onhover-show-div">
                  ...
                  <ul>
                    ...
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 img-60" src="{{ asset('assets/images/ecommerce/02.jpg') }}" alt="">
                    ...
                    <li><a class="view-cart" href="../template/cart.html">View Cart</a><a class="view-checkout f-right" href="../template/checkout.html">Checkout</a></li>
                  </ul>
                </div>
              </li>
              <li class="profile-nav onhover-dropdown p-0">
                ...
                <ul class="profile-dropdown onhover-show-div">
                  <li><a href="../template/user-profile.html"><i data-feather="user"></i><span>Account </span></a></li>
                  <li><a href="../template/email-application.html"><i data-feather="mail"></i><span>Inbox</span></a></li>
                  ...
                  <li><a href="../template/login.html"><i data-feather="log-in"> </i><span>Log in</span></a></li>
                </ul>
              </li>
            </ul>
          </div>
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">Josh</div>
            </div>
            </div>
          </script>
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="menu-box"> 
                    <ul>
                      <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title iconset" href="../template/index.html" target="_blank">
                      ...
                      <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title iconset" href="https://support.pixelstrap.com/agent/pixelstrap/pixelstrap/tickets/list/open-cases" target="_blank">
                          <svg class="stroke-icon">
                      ...
                      <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title iconset" href="https://docs.pixelstrap.com/Crocs/html/document/" target="_blank">
                          <svg class="stroke-icon">
            ...
            <div class="row starter-main">
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <p>Getting start with your project custom requirements using a ready template which is quite difficult and time taking process, Crocs Admin provides useful features to kick start your project development with no efforts !</p>
                    <ul>
                      <li>
                        <p>Crocs Admin provides you getting start pages with different layouts, use the layout as per your custom requirements and just change the branding, menu & content.</p>
                      </li>
                      <li>
                        <p>Every components in Crocs Admin are decoupled, it means use only components you actually need! Remove unnecessary and extra code easily just by excluding the path to specific SCSS, JS file.</p>
                      </li>
                      <li>
...
&lt;p&gt;Getting start with your project custom requirements using a ready template which is quite difficult and time taking process, Crocs Admin provides useful features to kick start your project development with no efforts !&lt;/p&gt;
&lt;ul&gt;
&lt;li&gt;&lt;p&gt;Crocs Admin provides you getting start pages with different layouts, use the layout as per your custom requirements and just change the branding, menu & content.&lt;/p&gt;&lt;/li&gt;
&lt;li&gt;&lt;p&gt;Every components in Crocs Admin are decoupled, it means use only components you actually need! Remove unnecessary and extra code easily just by excluding the path to specific SCSS, JS file.&lt;/p&gt;&lt;/li&gt;
